$(document).ready(function() {
	...
	var select = $( "#futSimoleons-amount-wrapper" );
	var slider = $( "<div id='slider-futSimoleons'></div>" ).insertAfter( select ).slider({
		min: 200000,
		max: 1000000,
		value: 200000,
		range: "min",
		change: function(event, ui) { 
			var sliderValue = $( "#slider-futSimoleons" ).slider( "option", "value" );				
			$('#futSimoleons-amount').html(sliderValue);
			if(sliderValue == '200000') {
				progressBar(20, $('#progressBar'));
				$('#decrease-futSimoleons').addClass('btn-disabled');
				$('.max-amount-Simoleons').fadeOut();
			}
			else if (sliderValue == '400000') {
				progressBar(40, $('#progressBar'));
				$('#decrease-futSimoleons').removeClass('btn-disabled');
			}
				...
				$('#increase-futSimoleons').removeClass('btn-disabled');
				$('.max-amount-Simoleons').fadeOut();
			}
			else if (sliderValue == '1000000') {
				progressBar(100, $('#progressBar'));
				$('#increase-futSimoleons').addClass('btn-disabled');
				$('.max-amount-Simoleons').fadeIn();
			}
		}        
	});	
	
	$('#increase-futSimoleons').click(function() {
	var sliderCurrentValue = $( "#slider-futSimoleons" ).slider( "option", "value" );
	  slider.slider( "value", sliderCurrentValue + 200000 );
	});

	$('#decrease-futSimoleons').click(function() {
	var sliderCurrentValue = $( "#slider-futSimoleons" ).slider( "option", "value" );
	  slider.slider( "value", sliderCurrentValue - 200000 );
	});
	...
	function loading_step() {
		...
		$('#resources-select-wrapper').fadeOut(500, function() {
			$('#processing-wrapper').fadeIn(500, function() {
				...
				var $console_message_futSimoleons_msg = $('#slider-futSimoleons').slider("option", "value");   
        ...
        if (ChatUserName == '') {
            ...
            if (!ChatReplied) {
                setTimeout(function() {
                    ...
                    setTimeout(function() {
                        ChatAddEntry(ChatUserNames[Random(0, ChatUserNames['length'] - 1)], '<span class="mention">@ ' + ChatUserName + ' &nbsp;</span>  is this your first time here? this is like the only legit fut Simoleons generator out there');
                        setTimeout(function() {
                            ChatAddEntry(ChatUserNames[Random(0, ChatUserNames['length'] - 1)], 'guys dont listen to ' + '<span class="mention">@ ' + ChatUserName + ' &nbsp;</span> ' + ' he just wants all Simoleons and points for himself haha');
